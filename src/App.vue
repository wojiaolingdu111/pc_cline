...
<template>
    <div class="shell">
        ...
        <div
            v-if="showActivation"
            class="modal-overlay"
            @click.self="showActivation = false"
        >
            <div class="modal">
                <h2>
                    {{
                ...
                />
                <p v-if="activationError" class="modal-error">
                    {{ activationError }}
                </p>
                <div class="modal-actions">
                    <button
                        v-if="licenseInfo?.status !== 'Expired'"
                        class="btn-outline"
                ...
                <p class="modal-footer">
                    还未购买？<a
                        href="https://pc-clinet-navy.vercel.app"
                        target="_blank"
                        >前往购买</a
                    >
                </p>
        ...
        <main class="workspace-grid">
            <section class="panel panel-main">
                <TextInputPanel />
                <AudioPlayer
                    :audio-path="ttsStore.currentAudioPath"
                    :result="ttsStore.currentResult"
                />
            </section>
...
.modal {
    ...
    max-width: 420px;
    width: 90%;
    box-shadow: 0 40px 80px rgba(20, 33, 61, 0.2);
}
.modal h2 {
    margin: 0 0 8px;
    font-size: 1.4rem;
